...
const enhancedDriversJSON = enhanceComponents(driversJSON);
...
const enhancedBodysJSON = enhanceComponents(bodysJSON);
...
const enhancedTiresJSON = enhanceComponents(tiresJSON);
...
const enhancedGlidersJSON = enhanceComponents(glidersJSON);
